...
class MCSimulation:
    ...
    def __init__(self, portfolio_data, weights="", num_simulation=1000, num_trading_days=252):
        ...
        if not "daily_return" in portfolio_data.columns.get_level_values(1).unique():
            close_df = portfolio_data.xs('Mid',level=1,axis=1).pct_change()
    ...
    def calc_cumulative_return(self):
        ...
        last_prices = self.portfolio_data.xs('Mid',level=1,axis=1)[-1:].values.tolist()[0]
    ...
    def plot_simulation(self):
        ...
        plot_title = f"{self.nSim} Simulations of Cumulative Price Increase Trajectories Over the Next {self.nTrading} Trading Days."
